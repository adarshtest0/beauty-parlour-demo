  ...
  return (
    <footer className="bg-gray-900 text-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Main Footer Content */}
        <motion.div className="py-16 grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand Section */}
          <motion.div className="md:col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-6">
              Experience luxury beauty treatments in a serene environment with
              certified experts.
            </p>
        ...
        {/* Bottom Section */}
        <motion.div className="border-t border-gray-800 py-8 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 Glow Beauty Salon. All rights reserved.
          </p>

          <motion.div className="flex items-center gap-2 text-pink-400 mt-4 sm:mt-0">
